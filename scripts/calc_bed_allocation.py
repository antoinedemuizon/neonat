...
from scripts.read_input import ReadInput, ReadInputWithNurse
...
class CalcBedAllocationWithNurse(CalcBedAllocation):
    """
    Class handling a bed allocation scenario.
    Require a ReadInputWithNurse object.
    """
    def __init__(self, inputs: ReadInputWithNurse, output_path=None):
        CalcBedAllocation.__init__(self, inputs, output_path)
...
class CalcTestNewStruct():
    ...
    def add_obj(self, obj):
        """
        """
        self.list_symbol.append(obj)

    def declare_all(self):
        """
        After read_input, feed set and co with input.
        """
        pass
    
    def all_equation(self):
        pass
